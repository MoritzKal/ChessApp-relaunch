...
def test_reload_idempotent_counter_once(tmp_path):
    ...
    before = model_loader.MODELS_LOADED.labels(model_id="m1", model_version="v1")._value.get()
    ...
    after = model_loader.MODELS_LOADED.labels(model_id="m1", model_version="v1")._value.get()
